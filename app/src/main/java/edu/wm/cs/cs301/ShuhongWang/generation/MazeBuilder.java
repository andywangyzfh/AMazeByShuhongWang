...
public class MazeBuilder implements Runnable {
	...
	public void run() {
		...
		try {
			...
			final BSPBuilder b = new BSPBuilder(order, dists, floorplan, width, height, colchange, expectedPartiters, mazePanel) ;
	...
	*/
	...
	/**
	 * Set mazePanel for drawing.
	 * 
	 * @param mazePanel the maze panel for drawing
	 */
